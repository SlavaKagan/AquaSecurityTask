...
func main() {
	...
	router.HandleFunc("/container", handlers.GetContainerForHost).Methods(http.MethodGet) //getContainersForHost
	router.HandleFunc("/books", handlers.AddContainer).Methods(http.MethodPost)           //postContainer
